...
1% divergent transitions. maybe run for longer??
...
3 divergent transitions after warmup with standard iter (2k) and warmup (1k). 

So I ran this one for a little longer, as it's the full model that I will
focus on. I doubled the iter and warmup and there were no divergent transitions.
